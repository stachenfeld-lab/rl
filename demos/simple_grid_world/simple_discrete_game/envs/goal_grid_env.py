...
class GoalGridEnv(gym.Env):
    ...
    def __init__(self):
        print('Warning: this code is largely untested and work-in-progress.')
        pg.init()
        pg.display.init()
    ...
    def reset(self):
        ...
        return self._get_image(), self._get_pos()
    ...
    def _get_image(self):
        img = pg.surfarray.array3d(self.screen).swapaxes(0, 1)
        return img 
    ...
    def step(self, action):
        ...
        pos = self._get_pos()
        return img, pos, reward, done, info
